...
{
    public class GetCreditValueWalletTransactionQuery : IGetCreditValueWalletTransactionQuery
    {
        private readonly HarveyCRMLoyaltyDbContext _dbContext;
        public GetCreditValueWalletTransactionQuery(HarveyCRMLoyaltyDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public GetCreditValueWalletTransactionResponse Execute(GetCreditValueWalletTransactionRequest request)
        {
            ...
            var response = new GetCreditValueWalletTransactionResponse();
            ...
            response.TotalCreditValue = queryWalletTransaction.Sum(x => x.Credit);
            return response;
        }
    }
}
