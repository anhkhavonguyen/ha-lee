...
namespace Harvey.PIM.Application.Infrastructure.Migrations
{
    ...
    [Migration("20181130102230_update_category_columm")]
    partial class update_category_columm
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Harvey.PIM.Application.Infrastructure.Domain.AssortmentAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("AssortmentId", "ReferenceId", "EntityType")
                        .IsUnique();

                    b.ToTable("AssortmentAssignments");
                });
            ...
            modelBuilder.Entity("Harvey.PIM.Application.Infrastructure.Domain.ChannelAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasIndex("ChannelId", "ReferenceId", "EntityType")
                        .IsUnique();
            ...
            modelBuilder.Entity("Harvey.PIM.Application.Infrastructure.Domain.Product", b =>
                {
                    b.HasOne("Harvey.PIM.Application.Infrastructure.Domain.Category", "Category")
                        .WithMany()
