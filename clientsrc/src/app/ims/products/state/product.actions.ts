...
export enum ProductActionTypes {
  ...
  LoadFieldTemplateModeEdit = '[Product] Load Field Template Mode Edit',
  LoadFieldTemplateModeEditSuccess = '[Product] Load Field Template Mode Edit Success',
}
...
export class LoadFieldTemplateModeEdit implements Action {
  readonly type = ProductActionTypes.LoadFieldTemplateModeEdit;
  constructor(public payload: string) { }
}

export class LoadFieldTemplateModeEditSuccess implements Action {
  readonly type = ProductActionTypes.LoadFieldTemplateModeEditSuccess;
  constructor(public payload: ProductModel) { }
}
...
export type ProductActions =
  ...
  | UpdateProductFail
  | LoadFieldTemplateModeEdit
  | LoadFieldTemplateModeEditSuccess
  | GetCategories
