...
namespace Harvey.CRMLoyalty.Api.Migrations
{
    ...
    [Migration("20181004065410_AddMembershipActionTypeTableMigrations")]
    partial class AddMembershipActionTypeTableMigrations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.ErrorLogSource", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.MembershipActionType", b =>
                {
                    b.Property<int>("Id");
                    ...
                    b.ToTable("MembershipActionTypes");

                    b.HasData(
                        new { Id = 0, TypeName = "Migration" },
                        new { Id = 1, TypeName = "New" },
                        new { Id = 2, TypeName = "Upgraded" },
                        new { Id = 3, TypeName = "Renew" },
                        new { Id = 4, TypeName = "Extend" },
                        new { Id = 5, TypeName = "Downgrade" },
                        new { Id = 6, TypeName = "Void" },
                        new { Id = 7, TypeName = "ChangeExpiry" },
                        new { Id = 8, TypeName = "Comment" }
                    );
                });
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.MembershipTransaction", b =>
                {
                    ...
                    b.Property<int>("MembershipActionTypeId");

                    b.Property<string>("MembershipTransactionReferenceId");
                    ...
                    b.HasIndex("MembershipActionTypeId");

                    b.HasIndex("MembershipTransactionReferenceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.PointTransaction", b =>
                {
                    ...
                    b.Property<string>("PointTransactionReferenceId");
                    ...
                    b.HasIndex("PointTransactionReferenceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.WalletTransaction", b =>
                {
                    ...
                    b.Property<string>("WalletTransactionReferenceId");
                    ...
                    b.HasIndex("WalletTransactionReferenceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.ErrorLogEntry", b =>
                {
                    b.HasOne("Harvey.CRMLoyalty.Application.Entities.ErrorLogSource", "ErrorLogSource")
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.MembershipTransaction", b =>
                {
                    ...
                    b.HasOne("Harvey.CRMLoyalty.Application.Entities.MembershipActionType", "MembershipActionTypeRef")
                        .WithMany("MembershipTransactionRefs")
                        .HasForeignKey("MembershipActionTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Harvey.CRMLoyalty.Application.Entities.MembershipTransaction", "MembershipTransactionReference")
                        .WithOne()
                        .HasForeignKey("Harvey.CRMLoyalty.Application.Entities.MembershipTransaction", "MembershipTransactionReferenceId");
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.PointTransaction", b =>
                {
                    ...
                    b.HasOne("Harvey.CRMLoyalty.Application.Entities.PointTransaction", "PointTransactionReference")
                        .WithOne()
                        .HasForeignKey("Harvey.CRMLoyalty.Application.Entities.PointTransaction", "PointTransactionReferenceId");
            ...
            modelBuilder.Entity("Harvey.CRMLoyalty.Application.Entities.WalletTransaction", b =>
                {
                    ...
                    b.HasOne("Harvey.CRMLoyalty.Application.Entities.WalletTransaction", "WalletTransactionReference")
                        .WithOne()
                        .HasForeignKey("Harvey.CRMLoyalty.Application.Entities.WalletTransaction", "WalletTransactionReferenceId");
                });
