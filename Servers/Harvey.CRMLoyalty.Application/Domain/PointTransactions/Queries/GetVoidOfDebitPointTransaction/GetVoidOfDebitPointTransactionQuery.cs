...
{
    public class GetVoidOfDebitPointTransactionQuery : IGetVoidOfDebitPointTransactionQuery
    {
        private readonly HarveyCRMLoyaltyDbContext _dbContext;
        public GetVoidOfDebitPointTransactionQuery(HarveyCRMLoyaltyDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public GetVoidOfDebitPointTransactionResponse Execute(GetVoidOfDebitPointTransactionRequest request)
        {
            ...
            var response = new GetVoidOfDebitPointTransactionResponse();
            ...
            response.TotalVoidOfDebitValue = queryPointTransaction.Sum(x => x.Credit);
            return response;
        }
    }
}
