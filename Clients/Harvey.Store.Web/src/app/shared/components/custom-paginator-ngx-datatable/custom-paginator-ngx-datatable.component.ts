...
@Component({
  selector: 'app-custom-paginator-ngx-datatable',
  templateUrl: './custom-paginator-ngx-datatable.component.html',
  styleUrls: ['./custom-paginator-ngx-datatable.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CustomPaginatorNgxDatatableComponent extends SuperDataTablePagerComponent {
