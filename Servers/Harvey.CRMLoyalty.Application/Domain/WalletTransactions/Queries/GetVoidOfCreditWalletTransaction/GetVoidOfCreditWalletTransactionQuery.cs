...
{
    public class GetVoidOfCreditWalletTransactionQuery : IGetVoidOfCreditWalletTransactionQuery
    {
        private readonly HarveyCRMLoyaltyDbContext _dbContext;
        public GetVoidOfCreditWalletTransactionQuery(HarveyCRMLoyaltyDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public GetVoidOfCreditWalletTransactionResponse Execute(GetVoidOfCreditWalletTransactionRequest request)
        {
            ...
            var response = new GetVoidOfCreditWalletTransactionResponse();
            ...
            response.TotalVoidOfCreditValue = queryWalletTransaction.Sum(x => x.Debit);
            return response;
        }
    }
}
